...
<html>
    <head>
        ...
        <script language="javascript" type="text/javascript" src="js/jquery.smart.compat.js"></script>
-->
        <link type="text/css" href="<?php render_theme_path() ?>/css/jquery-ui.css" rel="stylesheet">
        <script language="javascript" type="text/javascript" src="js/jquery-ui.js"></script>
        <link type="text/css" href="<?php render_theme_path() ?>/css/jquery.layout.css" rel="stylesheet">
        <script language="javascript" type="text/javascript" src="js/jquery.layout.js"></script>
        <style type="text/css">
...
-->
        ...
        <div id="left-pane" class="ui-layout-west">
            <!-- left bar -->
            <iframe src="<?php echo $leftUrl; ?>" name="left" width="100%" height="99%" frameborder="0" scrolling="auto" marginheight="0"></iframe>
        </div>

        <div id="right-pane" class="ui-layout-center">
            <!-- right bar -->
            <iframe src="<?php echo $rightUrl; ?>" name="right" width="100%" height="99%" frameborder="0" marginheight="0" scrolling="auto"></iframe>
        </div>
